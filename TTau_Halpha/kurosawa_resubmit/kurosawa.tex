...
wind ($3\,R_{*} < w_{i} < 25.4\,R_{*}$) may not be able to be launched
...
towards the symmetry axis as the wind travel higher above the disc.
...
R_{*}$ (not shown here) which satisfies the wind launching condition
...
significant amount of variablity, which may in some cases induced by
...
\begin{figure*}
  ...
  \caption{The dependence of the H$\alpha$ model profiles on the
    ...
    The wind mass-loss rates used in both models is
    $\dot{M}_{\mathrm{wind}}=10^{-8}~\mathrm{M_{\sun}~yr^{-1}}$ . 
...
(Fig.~\ref{fig:atlas02}).   The temperatures of the magnetospheres
