...
be absorbed by the gas locally, and re-emitted  optical and UV
...
\citet{martin:1996} qualitatively agree with those of
\citet{hartmann:1994}.
...
disc-wind model of \citet{krasnopolsky:2003} who used $p=-5/2$, the
...
H$\alpha$ on the temperature ($T_{\mathrm{max}}$) of the accretion flow
...
Fig.~\ref{fig:atlas_hybrid} reveals some problems
...
This work is supported by PPARC standard grant PPA/G/S/2001/00081
and PPARC rolling grant PP/C501609/1. 
