...
\title[On the formation of H$\alpha$ around classical T Tauri
  ...
  T Tauri star: the disc-wind-magnetosphere hybrid models}
...
opening angel of the disc wind is greater than the inclination angle.
For the disc wind models presented in this paper, we use $d=44~R_{*}$
to have a moderate amount of wind absorption at a moderate inclination
angle ($i\sim60^\circ$).
...
Fig.~\ref{fig:atlas_hybrid} are computed with limited
...
(\citet{finkenzeller:1984}) some lines may be explained by
...
\begin{figure}
  ...
  $\dot{M}_{\mathrm{acc}} =10^{-7}\,\mathrm{M_{\sun}\,yr{-1}}$ and
