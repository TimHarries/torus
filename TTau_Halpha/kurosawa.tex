...
towards the equatorial plane.  This tendency
...
Clearly, this is not consist with the trend seen in
...
as clearly seen in the figure. Specifically their values are 
...
magnetosphere (Figure~\ref{fig:atlas_hybrid} and
...
(c.f.~\citealt{koenigl:2000}) is consistent with the 
...
Additional H$\alpha$ model line profiles 
computed using disc-wind-magnetosphere hybrid model
(section~\ref{sub:result-discwind-hybrid}) are presented here.  All
the models use the reference parameters for the 
magnetospherical geometry and the photosphere as given in
...
$9500\Kelvin$ respectively.  The corresponding wind mass-loss rates
are used for $\mu=0.1$. In each set the profiles are presented for the
inclination angle of $10^\circ$, $55^\circ$, and $80^\circ$. 
...
\begin{figure}
  ...
  \caption{The H$\alpha$ atlas of the disc-wind-magnetosphere hybrid model with
