...
\begin{figure}
  ...
  \caption{The effect of the mass-loss rate to mass-accretion rate
    ...
    hybrid models for $\mu =$ 0.025 (dash-dot), 0.1
...
\begin{figure*}
  ...
  \begin{center}
	...
	scale=0.45]{figures/discwind_acc_inc_effect_m9_b1_t7000.eps}&
      \includegraphics[%
	clip,
	scale=0.45]{figures/disc_wind_acc_inc_effect_m9_b2_t7000.eps}\tabularnewline
    \end{tabular}
...
greater than the emission from the magnetosphere. Because of the
geometry of the wind, the P-Cyg absorption feature weakens as the
inclination increases. The optical depth of the wind is much higher in
...
hybrid models with $0.025<\mu<0.2$ are also consistent with the type
