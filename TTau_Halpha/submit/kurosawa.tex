...
wind acceleration rate (e,g,~$\beta=4$) is used. The discrepancy with
the observations is perhaps caused by the lack of the material
connecting the \emph{disc wind} to a collimated \emph{jet} in our
model, which may be excited by alternative heating mechanism
(e.g.~shocks) thus producing observable H$\alpha$ emission at large
