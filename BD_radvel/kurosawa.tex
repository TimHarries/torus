...
consecutive spectra are found to be between $XXX$ and  $XXX\,\kmps$,
which is much smaller than the expected RV variation based on the
models of \citet{palla:2005}; hence, found no/little indication of the
pulsations. 
