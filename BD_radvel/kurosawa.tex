...
cross-corelation curves. The RV dispersion of the objects in UScoOB
...
\caption{The binary detection probability (solid) as a function of the semimajor
  ...
  space, centred at $\log{a}=0.6$, and truncated at $a=15$~au. See text
  for a detail.}  
...
reasonably matches the expected distribution.  This lead us to
...
\kmps$.  No binary is detected for $\sigma_{\mathrm{sys}} > 
