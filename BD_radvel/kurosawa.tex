...
below $p=10^{-3}$ boundary value; hence, they become RV constant
objects as $\sigma_{\mathrm{sys}}=0.2\,\kmps$ is introduced. This
...
Fig~\ref{fig:chisq-test}), also have a good agreement with the
...
error of $0.2\,\kmps$  was added to the uncertainties in the RV
measurements, we found only 2 (GY~310 and USco~104) out of 17 objects
...
0.12~au. Hence, it is not surprising that we did not find USco~66 and
...
primary.  In addition, we found USco~104 as a binary candidate, but this
