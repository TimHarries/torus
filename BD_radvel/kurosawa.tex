...
\includegraphics[%
  clip,
  scale=0.9]{figures/radvel_all01.eps}
...
\includegraphics[%
  clip,
  scale=0.9]{figures/radvel_all02.eps}
...
\includegraphics[%
  clip,
  scale=0.46]{figures/chisq_hist.eps}
\end{center}
...
\includegraphics[%
  clip,
  scale=0.46]{figures/radvel_hist.eps}
...
% $2/17$ or $f=12^{+13}_{-8}$~per~cent for $a<0.1$~au.
%
% %
