...
\textcolor{red}{
  ...
  because it was determined from a few photospheric lines.
}

\textcolor{red}{
  The result of the heliocentric RV measurements (from two epochs for
  each object) is summarised in Table 2 along with their
  uncertainties.  The uncertainties listed in columns~4 and 6 along
  with the absolute/heliocentric RV values include the uncertainty of
  the absolute/heliocentric RV of the template star. On the other
  hand, the uncertainties in the `relative' radial velocities
  ($\sigma_{\mathrm{RRV}}$) listed in column~5 of the table do not
  include the uncertainty of the template star. It is
...
sources of systematic errors: (1)~the RV shifts caused by surface/atmospheric
