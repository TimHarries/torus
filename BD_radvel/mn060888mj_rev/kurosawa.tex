...
curve. 
\textcolor{red}{To quantify this point, we have computed the
...
from the left $\left(0 < -\log_{10}\left(p\right) < 2 \right)$ the
histogram since the objects in the second bin from the right
$\left(2.5 < -\log_{10}\left(p\right) < 3 \right)$ are `potentially'
