...
\textcolor{red}{
Finally, we note that the binary fraction found in this paper may be
over-estimated because of the nature of our survey (magnitude-limited
and incomplete), and because of a possible bias towards brighter
objects.
}
...
% LocalWords:  astro ph de Zeeuw de Zeeuw de Bruijne Hoogerwerf Lub Blaauw
% LocalWords:  Battrick
