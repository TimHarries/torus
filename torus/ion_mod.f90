...
subroutine addTransitions(thisIon)
  ...
  select case(thisIon%species)
     ...
     case("N II")
        call addTransition(thisIon,"1D_2","3P_0", 6529.0, 5.35e-7, 2.57e-10, 2.64e-10, 2.70e-10, 2.73e-10)
        ...
        call addTransition(thisIon,"1S_0","3P_2", 3071.4, 1.51e-4, 1.e-30, 1.e-30, 1.e-30, 1.e-30)
        ...
        call addTransition(thisIon,"5S^0_2","3P_2", 2140., 1.07e2, 1.e-30, 1.e-30, 1.e-30, 1.e-30)
     case("N III")
     ...
     case("O I")
        call addTransition(thisIon,"1D_2","3P_0", 6393.5, 7.23e-7, 1.2e-10, 2.66e-10, 0., 5.01e-10)
     ...
     case("O III")
        call addTransition(thisIon,"1D_2","3P_0", 4932.6, 2.74e-6, 2.13e-10, 2.29e-10, 2.45e-10, 2.52e-10) !!!!!!!!
        ...
        call addTransition(thisIon,"1S_0","3P_2", 2332.0, 7.85e-4, 2.72e-10, 2.93e-10, 3.17e-10, 3.29e-10)
        ...
        call addTransition(thisIon,"3P_2","3P_1", 518145., 9.76e-5, 1.23e0, 1.29e0, 1.34e0, 1.35e0)
...
!        call addTransition(thisIon,"5S^0_2","3P_2", 1666.1, 5.22e2, 1.07e0, 1.21e0, 1.25e0, 1.26e0)
     ...
     case("Ne III")
        call addTransition(thisIon,"1D_2","3P_0", 4012.8, 8.51e-6, 1.63e-10, 1.65e-10, 1.65e-10, 1.64e-10)
        call addTransition(thisIon,"1D_2","3P_1", 3967.5, 5.42e-2, 1.63e-10, 1.65e-10, 1.65e-10, 1.64e-10)!
        ...
        call addTransition(thisIon,"1S_0","3P_2", 1793.7, 3.94e-3, 1.51e-10, 1.69e-10, 1.75e-10, 1.79e-10)
        call addTransition(thisIon,"1S_0","1D_2", 3342.5, 2.71e0, 2.00e-1, 2.26e-1, 2.43e-1, 2.60e-1)
        call addTransition(thisIon,"3P_0", "3P_1", 3.60e5, 1.15e-3, 3.31e-1, 3.50e-1, 3.51e-1, 3.50e-1)
    ...
    case("S II")
     ...
     case("S III")
        call addTransition(thisIon,"1D_2", "3P_0", 8833.9, 5.82e-6, 9.07e-10, 8.39e-10, 8.29e-10, 8.30e-10)
