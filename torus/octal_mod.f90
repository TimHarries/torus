...
!                                   /
  ...
  TYPE octal
    ...
    REAL, DIMENSION(:,:), POINTER :: kappaAbs => NULL()    ! cont absorption opacities
    REAL, DIMENSION(:,:), POINTER :: kappaSca => NULL()    ! scattering opacities
    ...
    REAL(KIND=doubleKind), DIMENSION(:,:), POINTER ::  N => NULL()  ! stateq level pops
    ...
    INTEGER, DIMENSION(8) :: label                         ! numeric label for each subcell GET RID OF THIS? 
