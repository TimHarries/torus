...
c     .............................................................
      ...
      call getRefractiveIndex(lambda, cmr, cmi)
      write(*,*) cmr,cmi
...
c     .........................................
          ...
          do 10 n = 1,nc
            ...
            qExt = qExt+rf*aimag(cim*(f(n)+ci*g(n)))*gfac
10        continue            
          kappaExt = kappaExt + qExt*normFac*a**(-qDist)*da
c     ..........................................
...
c     ..........................................
          ...
          qsca = 0.
          do 20 n = 1,nc
            qsca = qsca+(abs(f(n))**2+abs(g(n))**2)*cnrm(n)*gfac       
20        continue
          kappaSca = kappaSca + qSca*normFac*a**(-qDist)*da
...
c     ..........................................
          kappaabs = kappaext-kappasca                                  eq 4.15
...
c     ..............................................................
      real x
      complex b,z,cm,ci,hkl(1000),an,amat(1000),f(1000),g(1000)
      common /cfcom2/ f,g,cnrm
      dimension cnrm(1000)
      ci = (0.0,1.0)
c     ......................................................
