      ...
      integer  lbnd(2), ubnd(2), nelm
       ...
       write(*,'(a,i4,a,i4)') "Writing image: ",npix," by ",npix
...
!
      ...
      call fillNdfImageQUV(%val(qptr), npix,  thisImageQ)
      call fillNdfImageQUV(%val(uptr), npix,  thisImageU)
      call fillNdfImageQUV(%val(vptr), npix,  thisImageV)
      call fillNdfImageQUV(%val(velptr), npix,  thisImageVel)
