      ...
      subroutine miePhaseMatrix(mReal, mImag, xSize, costheta, mieMatrix)
      ...
      real :: normFac, dMu
      integer :: nMu = 100
      real :: mReal, mImag, costheta
      real :: xSize, x, cmr, cmi,  t, theta, costh, rn, p1, p2
...
!     ....................................................              and
          ...
          mieMatrix%element = 0.
          mieMatrix%element(1,1) = p11
          mieMatrix%element(1,2) = -pl*p11
          mieMatrix%element(2,1) = -pl*p11
          mieMatrix%element(2,2) = p11

          mieMatrix%element(3,3) = p33p11*p11
          mieMatrix%element(3,4) = p34p11*p11
          mieMatrix%element(4,3) = -p34p11*p11
          mieMatrix%element(4,4) = p33p11*p11
