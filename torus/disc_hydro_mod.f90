...
!    end do
 ...
 include 'mpif.h'
    ...
    print *,'Process ',my_rank,' waiting to do lucy.'
    ...
    if(my_rank == 0) then
       ...
       call plot_AMR_values(grid, "rho", plane_for_plot, 0.0, plotfile,.true., .false., boxfac=0.005)
       ...
       call plot_AMR_values(grid, "temperature", plane_for_plot, 0.0, plotfile,.true., .false., boxfac=0.005)
