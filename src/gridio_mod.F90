    ...
    recursive subroutine writeOctreePrivateFlexi(thisOctal,fileFormatted, grid)
      ...
      use inputs_mod, only : amr2d, amr3d
       ...
       if (writeThisOctal) then
          ...
          call writeAttributePointerFlexi(20, "tempStorage", thisOctal%tempStorage, fileFormatted)
...
!         write(*,*) myrankglobal, " tag ",tag
         ...
         case("tempStorage")
            call readPointerFlexi(20, thisOctal%tempStorage, fileFormatted)
         case("heHeating")
   ...
   subroutine receiveOctalViaMPI(thisOctal, ithread)
     ...
     integer :: ierr
      ...
      do while (.true.)
         ...
         case("tempStorage")
            call receivePointerFlexi(thisOctal%tempStorage, ithread)
         case("heHeating")
    ...
    subroutine sendOctalViaMPI(thisOctal, ithread)
     ...
     integer :: iThread
      ...
      call sendAttributePointerFlexi(iThread, "tempStorage", thisOctal%tempStorage)
