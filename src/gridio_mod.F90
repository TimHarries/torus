...
#else
 implicit none
  logical, parameter ::  uncompresseddumpfiles = .true.
  integer, parameter :: buffer = 0
  integer, parameter :: nbuffer = 0
  integer, parameter :: maxbuffer = 0
#endif
...
!          print *, " write : ghostcell ", thisOctal%ghostCell
          ...
          call writeAttributePointerFlexi(20, "sourceRadMom", thisOctal%sourceRadMom, fileFormatted)
          call writeAttributePointerFlexi(20, "diffuseRadMom", thisOctal%diffuseRadMom, fileFormatted)
          call writeAttributePointerFlexi(20, "dustRadMom", thisOctal%dustRadMom, fileFormatted)
          call writeAttributePointerFlexi(20, "gasRadMom", thisOctal%gasRadMom, fileFormatted)
          call writeAttributePointerFlexi(20, "kappaTimesFlux", thisOctal%kappaTimesFlux, fileFormatted)
          call writeAttributePointerFlexi(20, "sourceKappaTimesFlux", thisOctal%sourceKappaTimesFlux, fileFormatted)
          call writeAttributePointerFlexi(20, "diffuseKappaTimesFlu", thisOctal%diffuseKappaTimesFlux, fileFormatted)
          call writeAttributePointerFlexi(20, "dustKappaTimesFlux", thisOctal%dustKappaTimesFlux, fileFormatted)
          call writeAttributePointerFlexi(20, "gasKappaTimesFlux", thisOctal%gasKappaTimesFlux, fileFormatted)
          call writeAttributePointerFlexi(20, "kappaTimesFluxHistory", thisOctal%kappaTimesFluxHistory, fileFormatted)
          call writeAttributePointerFlexi(20, "habingFlux", thisOctal%habingFlux, fileFormatted)
...
!       print *, myrankglobal, "reading private flexi"
       call readOctreePrivateFlexi(grid%octreeRoot,mynull,fileFormatted, nOctal, grid)
!       print *, myrankglobal, "done reading private flexi"
    ...
    if (associated(value)) then
       if (fileFormatted) then
          ...
          if (uncompressedDumpFiles) then
             ...
             call writeCompressedFile(lunit, value(1:SIZE(value,1),1:SIZE(value,2)))
#else
             call torus_abort("not built for compression")
#endif
          endif
       endif
    endif
...
#else
            call torus_abort("not built for compression, read")
#endif
         endif
      endif
      dataType = ADJUSTL(dataType)
      ...
      do while (.true.)
         ...
         if (fileFormatted) then
            ...
            if (uncompressedDumpFiles) then
               ...
               call readCompressedfile(20, tag)
#else
               call torus_abort("not built to use compression")
#endif
            endif
         endif
         tag = ADJUSTL(tag)
!         write(*,*) myrankglobal, " tag ",tag
         ...
         case("blackbody")
            call readPointerFlexi(20, thisOctal%blackbody, fileFormatted)
         case("nH")
...
!            print *, " read : ghostcell ", thisOctal%ghostCell
         ...
         case("sourceRadMom")
            call readPointerFlexi(20, thisOctal%sourceRadMom, fileFormatted)
         case("diffuseRadMom")
            call readPointerFlexi(20, thisOctal%diffuseRadMom, fileFormatted)
         case("dustRadMom")
            call readPointerFlexi(20, thisOctal%dustRadMom, fileFormatted)
         case("gasRadMom")
            call readPointerFlexi(20, thisOctal%gasRadMom, fileFormatted)
         case("kappaTimesFlux")
            call readPointerFlexi(20, thisOctal%kappaTimesFlux, fileFormatted)
         case("sourceKappaTimesFlux")
            call readPointerFlexi(20, thisOctal%sourceKappaTimesFlux, fileFormatted)
         case("diffuseKappaTimesFlu")
            call readPointerFlexi(20, thisOctal%diffuseKappaTimesFlux, fileFormatted)
         case("dustKappaTimesFlux")
            call readPointerFlexi(20, thisOctal%dustKappaTimesFlux, fileFormatted)
         case("gasKappaTimesFlux")
            call readPointerFlexi(20, thisOctal%gasKappaTimesFlux, fileFormatted)
         case("kappaTimesFluxHistory","kappaTimesFluxHistor")
            call readPointerFlexi(20, thisOctal%kappaTimesFluxHistory, fileFormatted)
         case("habingFlux")
            call readPointerFlexi(20, thisOctal%habingFlux, fileFormatted)
         case("UVvector")
            call readPointerFlexi(20, thisOctal%UVvector, fileFormatted)
         case("UVvectorPlus")
            call readPointerFlexi(20, thisOctal%UVvectorPlus, fileFormatted)
         case("UVvectorMinus")
            call readPointerFlexi(20, thisOctal%UVvectorMinus, fileFormatted)
   ...
   subroutine receiveOctalViaMPI(thisOctal, ithread)
     ...
     integer :: ierr
      ...
      do while (.true.)
         ...
         case("blackbody")
            call receivePointerFlexi(thisOctal%blackbody, ithread)
         case("nH")
         ...
         case("sourceRadMom")
            call receivePointerFlexi(thisOctal%sourceRadMom, ithread)
         case("diffuseRadMom")
            call receivePointerFlexi(thisOctal%diffuseRadMom, ithread)
         case("dustRadMom")
            call receivePointerFlexi(thisOctal%dustRadMom, ithread)
         case("gasRadMom")
            call receivePointerFlexi(thisOctal%gasRadMom, ithread)
         case("kappaTimesFlux")
            call receivePointerFlexi(thisOctal%kappaTimesFlux, ithread)
         case("sourceKappaTimesFlux")
            call receivePointerFlexi(thisOctal%sourceKappaTimesFlux, ithread)
         case("diffuseKappaTimesFlu")
            call receivePointerFlexi(thisOctal%diffuseKappaTimesFlux, ithread)
         case("dustKappaTimesFlux")
            call receivePointerFlexi(thisOctal%dustKappaTimesFlux, ithread)
         case("gasKappaTimesFlux")
            call receivePointerFlexi(thisOctal%gasKappaTimesFlux, ithread)
         case("kappaTimesFluxHistory", "kappaTimesFluxHistor")
            call receivePointerFlexi(thisOctal%kappaTimesFluxHistory, ithread)
         case("habingFlux")
            call receivePointerFlexi(thisOctal%habingFlux, ithread)
         case("UVvector")
    ...
    subroutine sendOctalViaMPI(thisOctal, ithread)
     ...
     integer :: iThread
      ...
      call sendAttributePointerFlexi(iThread, "blackbody", thisOctal%blackbody)
      ...
      call sendAttributePointerFlexi(iThread, "sourceRadMom", thisOctal%sourceRadMom)
      call sendAttributePointerFlexi(iThread, "diffuseRadMom", thisOctal%diffuseRadMom)
      call sendAttributePointerFlexi(iThread, "dustRadMom", thisOctal%dustRadMom)
      call sendAttributePointerFlexi(iThread, "gasRadMom", thisOctal%gasRadMom)
      call sendAttributePointerFlexi(iThread, "kappaTimesFlux", thisOctal%kappaTimesFlux)
      call sendAttributePointerFlexi(iThread, "sourceKappaTimesFlux", thisOctal%sourceKappaTimesFlux)
      call sendAttributePointerFlexi(iThread, "diffuseKappaTimesFlu", thisOctal%diffuseKappaTimesFlux)
      call sendAttributePointerFlexi(iThread, "dustKappaTimesFlux", thisOctal%dustKappaTimesFlux)
      call sendAttributePointerFlexi(iThread, "gasKappaTimesFlux", thisOctal%gasKappaTimesFlux)
      call sendAttributePointerFlexi(iThread, "kappaTimesFluxHistory", thisOctal%kappaTimesFluxHistory)
      call sendAttributePointerFlexi(iThread, "habingFlux", thisOctal%habingFlux)
